...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/23 20:14:29 by ayermeko          #+#    #+#             */
/*   Updated: 2024/06/23 20:21:41 by ayermeko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	*xpm_i(t_data *d, char *path, t_texture *t)
{
	return (mlx_xpm_file_to_image(d->mlx_ptr, path, t->px_size, t->px_size));
}

static void	render_characters(t_data *data, t_texture *t)
{
