...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/23 18:53:11 by ayermeko          #+#    #+#             */
/*   Updated: 2024/06/24 16:23:37 by ayermeko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../include/so_long.h"

static int	object_tracker(t_map *c)
{
	if (c->check == 'E')
		c->e_count++;
	if (c->check == 'P')
...
static int	walls_and_components(t_map *c)
{
...
static int	valid_map_format(t_map *c)
{
	if (c->line[0] == '\n')
		return (-1);
	if (c->current_line == 0)
