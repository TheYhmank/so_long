...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/23 18:50:37 by ayermeko          #+#    #+#             */
/*   Updated: 2024/06/23 19:30:42 by ayermeko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../include/so_long.h"

static void	draw_objects(t_data *data, t_map *c, t_texture *t)
{
...
static void	map_window(t_data *data, t_map *c, t_texture *t)
{
	c->width = SIZE * c->len;
